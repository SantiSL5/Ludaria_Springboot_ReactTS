...
const ListGames = ({ list, deleteProduct, deleteManyProducts, changeForm }: any) => {
    ...
    const columns = [
        ...
        {
            name: 'Launch Date',
            selector: (row: any) => row.launchDate,
            sortable: true
        },
        {
            name: 'Duration',
        ...
        {
            name: 'Min Players',
            selector: (row: any) => row.minPlayers,
            sortable: true
        },
        {
            name: 'Max Players',
            selector: (row: any) => row.maxPlayers,
            sortable: true
        },
        {
            name: 'Operations',
